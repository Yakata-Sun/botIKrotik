        ...
        for (const modelId of modelsToTry) {
            try {
                ...
                const messages = [
                    ...
                    { role: 'user', content: `${baziData}\n\nЗАДАЧА: Опиши элемент личности через мягкие образы и коучинговый подход. Опиши основные черты характера без упоминания китайских элементов, только образы в мягком коучинговом стиле. Пиши только выводы анализа. Используй эмодзи` }
                ];
