...
const astro = {
    handle: async (ctx, userSettings, userHistory, menus) => {
        ...
        const menuButtons = ['💎 Услуги', '📈 Быстрый Коучинг', '✨ Личная Сказка', '⬅️ Назад', 'Главное меню'];
...
- Опиши 3 силы и 2 слабости как союзников и препятствия в контексте этого запроса.
- Дай коуч-совет.
- Используй мягкий стиль Пути Героя. Без китайских терминов.
`;
