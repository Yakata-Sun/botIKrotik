...
`;
 // Формируем массив для ИИ
        ...
        if (!answer) {
            return await ctx.reply("😔 Извините, сейчас связь со звездами прервалась, возможно слишком много запросов боту. Попробуйте отправить данные еще раз чуть позже или утром");
        }
