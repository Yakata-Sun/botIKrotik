...
async function handleReceipt(ctx) {
  try {
    ...
    await ctx.reply("✅ Спасибо! Ваш чек успешно принят и передан Марии для проверки. В ближайшее время она с вами свяжется для уточнения выбранного формата и даты первой сессии");
